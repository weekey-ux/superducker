...
/// <param name="CurrentVersion">本地当前版本字符串（如 "1.2.2"，不带 v 前缀）。</param>
/// <param name="LatestVersion">远端最新版本字符串（如 "1.2.2"，不带 v 前缀）。</param>
...
public static class UpdateChecker
{
    ...
    /// </summary>
    /// <param name="currentVersion">当前本地版本字符串（如 "1.2.2" 或 "v1.2.2"）。允许为 null/空（视为 "0.0.0"）。</param>
